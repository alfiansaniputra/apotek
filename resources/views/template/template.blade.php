...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>ADM </b>Apotik</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>Welcome</a></li>
          </ul>
        </li>
        <li {{{ (Request::is('apotik/detail') ? 'class=active' : '') }}}><a href="{{url('apotik/detail')}}"><i class="fa fa-edit"></i> <span>Detail</span></a></li>
        <li {{{ (Request::is('apotik/resep') ? 'class=active' : '') }}}><a href="{{url('apotik/resep')}}"><i class="fa fa-sticky-note-o"></i> <span>Resep</span></a></li>
        <li {{{ (Request::is('apotik/obat') ? 'class=active' : '') }}}><a href="{{url('apotik/obat')}}"><i class="fa fa-glass"></i> <span>Obat</span></a></li>
        <li {{{ (Request::is('apotik/pasien') ? 'class=active' : '') }}}><a href="{{url('apotik/pasien')}}"><i class="fa fa-wheelchair"></i> <span>Pasien</span></a></li>
        <li {{{ (Request::is('apotik/poliklinik') ? 'class=active' : '') }}}><a href="{{url('apotik/poliklinik')}}"><i class="fa fa-hospital-o"></i> <span>Poliklinik</span></a></li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Multi User</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="header">Abot Dashboard</li>
          <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>How To Use<small class="label pull-right bg-blue">Comming soon</small></span></a></li>
          <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Feature<small class="label pull-right bg-blue">Comming soon</small></span></a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017-2018 <a href="saniputragroup.com">Apotik ADM</a>.</strong> All rights
    reserved.
  </footer>
