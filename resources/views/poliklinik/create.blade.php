...
<div class="col-md-10 col-md-offset-1" style="padding: 0px 80px;">
    <form class="form-horizontal" action="/apotik/poliklinik" method="post">

                <div class="form-group">
                  <label  class="col-sm-2 control-label">id_kode_plk</label>
                  <div class="col-sm-10">
                    <input name="id_kode_plk" type="text" class="form-control"  placeholder="id_kode_plk">
                  </div>
                </div>
                <div class="form-group">
                  <label  class="col-sm-2 control-label">nama_plk</label>
                  <div class="col-sm-10">
                    <input name="nama_plk" type="text" class="form-control"  placeholder="nama_plk">
                  </div>
                </div>
                <center>
